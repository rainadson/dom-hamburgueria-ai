...
export default function ManualOrder(){
 ...
 <label>Nome<input required maxLength={150} value={form.customer_name} onChange={e=>field('customer_name',e.target.value)}/></label><label>Telefone<input key={selectedCustomer?.phone||'manual-phone'} required type="tel" maxLength={20} value={selectedCustomer?.phone||form.customer_phone} onChange={e=>{setSelectedCustomer(null);field('customer_phone',e.target.value);}}/></label></fieldset>
